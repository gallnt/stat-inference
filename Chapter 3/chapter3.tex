...
\begin{enumerate}
    ...
    % 3.3
    \item In this case a car has to pass through for the first second, no car passes in the 
    next three seconds (three second wait), and no car passes through for another three 
    seconds (person is crossing the road).
\end{enumerate}
